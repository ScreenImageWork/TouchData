...
public class SwitchFileDilaog implements IControler {
	...
	public SwitchFileDilaog(Context context){
	...
	public void show(String devices[],FileEntity fe){
		mDevicesListAdapter.setData(devices);
	...
	class FileListAdapter extends BaseAdapter{
		...
		public View getView(int arg0, View arg1, ViewGroup arg2) {
			...
			if(selectIndex == arg0){
				...
				updateTimeTv.setTextColor(Color.BLUE);
				sizeTv.setTextColor(Color.BLUE);
			}else{
				nameTv.setTextColor(Color.WHITE);
				updateTimeTv.setTextColor(Color.WHITE);
	...
	class DevicesListAdapter extends BaseAdapter{
		...
		public View getView(int arg0, View arg1, ViewGroup arg2) {
			...
			if(select == arg0){
				deviceNameTv.setTextColor(Color.BLUE);
			}else{
