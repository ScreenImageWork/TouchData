...
public class Constant
{
    ...
    public static String shareDir = ""; //本地分享文件夹  目前里面所有的资源必须都是图片

    public static String shareTitle = ""; //分享页面标题

    public static String sharSubtitle = "";//分享页面副标题
    ...
    public static interface Config
    {
        ...
        public static final String Web_Root = "/nexvision/sqrc";
